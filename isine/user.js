...
router.post('/submit_edit', upload.array(),  function(req, res){
  ...
  // senjata
  //console.log(req.body)
  connection.query("update user SET username='"+req.body.username+"', pwd='"+sha1(req.body.pwd)+"', fullname='"+req.body.fullname+"', NIP='"+req.body.NIP+"', email='"+req.body.email+"', telp='"+req.body.telp+"' WHERE id_user='"+req.body.id_user+"' ", function(err, rows, fields) {
    if (err) throw err;
    numRows = rows.affectedRows;
  })
